...
(async function() {
  ...
  await (this.importScript('https://raw.githubusercontent.com/Community-Spotlight/promotion-exports/refs/heads/main/scripts/community-spotlight.js').loadPromise);
